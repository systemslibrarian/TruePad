...
# The deployment-evaluator corpus is a 3.0 artifact generated by
# scripts/gen-evaluator-corpus.ts from src/claims/shannon-deployment.ts — NOT by
# this released-wire generator — so it is not part of the v2.0.0 snapshot. Its
# cross-language conformance is proven by DeploymentCorpusTest and the TS
# tests/deployment-evaluator-corpus.test.ts.
exclude=(-x deployment-evaluator-v3.json)
if (( check )); then
